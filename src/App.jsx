...
const MEASURABLE_DRILLS=["HT","WT","40","VRT","BRD","3C","SHT"];
const MEASURABLE_COMPOSITES=["ATH","SPD","AGI","EXP"];
const MEASURABLE_RAW=["ARM","HND","WING"];
